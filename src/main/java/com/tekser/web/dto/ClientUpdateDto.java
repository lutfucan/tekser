...
public class ClientUpdateDto {
    ...
    public ClientUpdateDto(Long id,
                           @NotBlank(message = "İsim gerekli") String name,
                           @NotBlank(message = "Soyadı gerekli") String surname,
                           String phone, String gsm, String email, String address, String notes) {
        this.id = id;
        this.name = name;
